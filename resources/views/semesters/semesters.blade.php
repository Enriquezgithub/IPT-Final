...
@section('content')
    ...
    <div class="border shadow mb-5">
        <h2 class="ms-2 text-primary">Student - Class</h2>
    </div>
    ...
    <div class="container border shadow rounded" style="width: 90%">
        ...
        <div class="row align-center">
            <p class="text-decoration-underline fw-bold mt-3 h5 text-success col-9">List of Student - Class</p>
            <div class="col mt-3 ms-2">
              <input type="text" id="searchInput" placeholder="Search by ID" class="ms-4">
              <a href="{{url('/semesters/create')}}" class=" btn bg-primary text-white">
        ...
        <div class="bg-white mt-2">
            <table class="table table-bordered table-striped " id="studentTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$semester->id}}</td>
                        <td>{{$semester->student->name}}</td>
                        <td>{{$semester->loader->id}}</td>
